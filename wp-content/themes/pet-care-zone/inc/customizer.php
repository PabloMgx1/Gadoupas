...
function pet_care_zone_customize_register($wp_customize){
    ...
    $wp_customize->add_setting('pet_care_zone_logo_title', array(
        'default' => true,
        'sanitize_callback' => 'pet_care_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'pet_care_zone_logo_title',array(
        'label'          => __( 'Enable Disable Title', 'pet-care-zone' ),
        'section'        => 'title_tagline',
        'settings'       => 'pet_care_zone_logo_title',
        'type'           => 'checkbox',
    )));

    $wp_customize->add_setting('pet_care_zone_logo_text', array(
        'default' => true,
        'sanitize_callback' => 'pet_care_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'pet_care_zone_logo_text',array(
        'label'          => __( 'Enable Disable Tagline', 'pet-care-zone' ),
        'section'        => 'title_tagline',
        'settings'       => 'pet_care_zone_logo_text',
        'type'           => 'checkbox',
    )));
